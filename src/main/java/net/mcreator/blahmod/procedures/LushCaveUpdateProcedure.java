...
import net.mcreator.blahmod.block.MossyStoneBlock;
...
public class LushCaveUpdateProcedure extends BlahmodModElements.ModElement {
	public LushCaveUpdateProcedure(BlahmodModElements instance) {
		super(instance, 1642);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BlahmodMod.LOGGER.warn("Failed to load dependency x for procedure LushCaveUpdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BlahmodMod.LOGGER.warn("Failed to load dependency y for procedure LushCaveUpdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BlahmodMod.LOGGER.warn("Failed to load dependency z for procedure LushCaveUpdate!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				BlahmodMod.LOGGER.warn("Failed to load dependency world for procedure LushCaveUpdate!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Blocks.CAVE_AIR.getDefaultState().getBlock())) {
			if (((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == Blocks.STONE.getDefaultState().getBlock())) {
				if ((Math.random() < 0.95)) {
					world.setBlockState(new BlockPos((int) x, (int) (y - 1), (int) z), MossyStoneBlock.block.getDefaultState(), 3);
				...
				if ((Math.random() < 0.1)) {
					world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.MOSSY_COBBLESTONE_SLAB.getDefaultState(), 3);
					if ((Math.random() < 0.25)) {
						world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.COBBLESTONE_SLAB.getDefaultState(), 3);
					}
				}
			}
			if (((world.getBlockState(new BlockPos((int) x, (int) (y - 2), (int) z))).getMaterial() == net.minecraft.block.material.Material.ROCK)) {
				if ((!(((world.getBlockState(new BlockPos((int) x, (int) (y - 2), (int) z)))).getBlock() instanceof IWaterLoggable))) {
					if ((Math.random() < 0.02)) {
						if ((Math.random() < 0.75)) {
							world.setBlockState(new BlockPos((int) x, (int) (y - 1), (int) z), Blocks.MOSSY_COBBLESTONE.getDefaultState(), 3);
						} else {
							world.setBlockState(new BlockPos((int) x, (int) (y - 1), (int) z), Blocks.COBBLESTONE.getDefaultState(), 3);
						}
						if ((Math.random() < 0.75)) {
							world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.MOSSY_COBBLESTONE_WALL.getDefaultState(), 3);
						} else {
							world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
						}
					}
				}
			}
								...
								|| (((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == Blocks.CAVE_AIR
										...
										|| (((world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z))).getBlock() == Blocks.CAVE_AIR
												...
												|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z - 1))))
														...
														|| ((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z + 1))))
																.getBlock() == Blocks.CAVE_AIR.getDefaultState().getBlock()))))))) {
					world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.MOSSY_COBBLESTONE.getDefaultState(), 3);
					if ((Math.random() < 0.25)) {
