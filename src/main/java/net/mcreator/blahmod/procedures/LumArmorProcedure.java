...
public class LumArmorProcedure extends BlahmodModElements.ModElement {
	public LumArmorProcedure(BlahmodModElements instance) {
		super(instance, 606);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				BlahmodMod.LOGGER.warn("Failed to load dependency entity for procedure LumArmor!");
			return;
		}
		...
		if ((((((entity instanceof LivingEntity)
				...
				&& (((entity instanceof LivingEntity)
						...
						: ItemStack.EMPTY).getItem() == new ItemStack(LumiteArmorItem.body, (int) (1)).getItem()))
				&& ((((entity instanceof LivingEntity)
						? ((LivingEntity) entity).getItemStackFromSlot(EquipmentSlotType.fromSlotTypeAndIndex(EquipmentSlotType.Group.ARMOR, (int) 1))
						: ItemStack.EMPTY).getItem() == new ItemStack(LumiteArmorItem.legs, (int) (1)).getItem())
						&& (((entity instanceof LivingEntity)
								? ((LivingEntity) entity)
										.getItemStackFromSlot(EquipmentSlotType.fromSlotTypeAndIndex(EquipmentSlotType.Group.ARMOR, (int) 0))
								: ItemStack.EMPTY).getItem() == new ItemStack(LumiteArmorItem.boots, (int) (1)).getItem())))) {
			if (entity instanceof LivingEntity)
