...
import net.mcreator.blahmod.entity.renderer.EskimoZombieRenderer;
...
public class EskimoZombieEntity extends BlahmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("eskimo_zombie").setRegistryName("eskimo_zombie");
	public EskimoZombieEntity(BlahmodModElements instance) {
		super(instance, 95);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EskimoZombieRenderer.ModelRegisterHandler());
