...
import net.mcreator.blahmod.procedures.DarkMatterSlimeDropsProcedure;
import net.mcreator.blahmod.itemgroup.CreativeTabBlahItemsItemGroup;
import net.mcreator.blahmod.entity.renderer.DarkMatterJellyfishRenderer;
...
public class DarkMatterJellyfishEntity extends BlahmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1.7999999999999998f)).build("dark_matter_jellyfish").setRegistryName("dark_matter_jellyfish");
	public DarkMatterJellyfishEntity(BlahmodModElements instance) {
		super(instance, 1896);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarkMatterJellyfishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -3407617, new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab))
				.setRegistryName("dark_matter_jellyfish_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				DarkMatterSlimeDropsProcedure.executeProcedure($_dependencies);
			}
		}
