...
public class SkyForestBiome extends BlahmodModElements.ModElement {
	public static Biome biome;
	public SkyForestBiome(BlahmodModElements instance) {
		super(instance, 1266);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("blahmod:sky_forest"));
			}
		}
	}
	@Override
