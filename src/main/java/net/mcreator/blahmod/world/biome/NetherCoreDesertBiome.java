...
import net.mcreator.blahmod.entity.IceCubeEntity;
import net.mcreator.blahmod.entity.EskimoZombieEntity;
import net.mcreator.blahmod.block.NetherfrostBlock;
import net.mcreator.blahmod.block.FrostSandBlock;
...
public class NetherCoreDesertBiome extends BlahmodModElements.ModElement {
	public static Biome biome;
	public NetherCoreDesertBiome(BlahmodModElements instance) {
		super(instance, 649);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6889240).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-6889240).withFoliageColor(10387789).withGrassColor(-1).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(FrostSandBlock.block.getDefaultState(),
								NetherfrostBlock.block.getDefaultState(), NetherfrostBlock.block.getDefaultState())));
				DefaultBiomeFeatures.withFrozenTopLayer(biomeGenerationSettings);
				DefaultBiomeFeatures.withFrozenTopLayer(biomeGenerationSettings);
				MobSpawnInfo.Builder mobSpawnInfo = new MobSpawnInfo.Builder().isValidSpawnBiomeForPlayer();
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.GHAST, 10, 1, 2));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EskimoZombieEntity.entity, 2, 3, 5));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(IceCubeEntity.entity, 4, 4, 4));
				...
				event.getRegistry().register(biome.setRegistryName("blahmod:nether_core_desert"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("nether_core_desert_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("nether_core_desert_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("nether_core_desert_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
