...
public class SkySavannaBiome extends BlahmodModElements.ModElement {
	public static Biome biome;
	public SkySavannaBiome(BlahmodModElements instance) {
		super(instance, 1269);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-10053121).setWaterFogColor(-10053121)
						.withSkyColor(7972607).withFoliageColor(-9129620).withGrassColor(-9129620).build();
				...
				event.getRegistry().register(biome.setRegistryName("blahmod:sky_savanna"));
			}
		}
	}
	@Override
