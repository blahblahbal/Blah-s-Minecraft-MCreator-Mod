...
public class SkyPlainsBiome extends BlahmodModElements.ModElement {
	public static Biome biome;
	public SkyPlainsBiome(BlahmodModElements instance) {
		super(instance, 1265);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-10053121).setWaterFogColor(-10053121)
						.withSkyColor(7972607).withFoliageColor(-10040320).withGrassColor(-10040320).build();
				...
				event.getRegistry().register(biome.setRegistryName("blahmod:sky_plains"));
			}
		}
	}
	@Override
