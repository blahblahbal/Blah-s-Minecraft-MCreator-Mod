...
public class SkyBirchForestBiome extends BlahmodModElements.ModElement {
	public static Biome biome;
	public SkyBirchForestBiome(BlahmodModElements instance) {
		super(instance, 1268);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("blahmod:sky_birch_forest"));
			}
		}
	}
	@Override
