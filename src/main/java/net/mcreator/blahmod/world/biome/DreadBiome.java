...
public class DreadBiome extends BlahmodModElements.ModElement {
	public static Biome biome;
	public DreadBiome(BlahmodModElements instance) {
		super(instance, 579);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-16777216).setWaterFogColor(-14869223)
						.withSkyColor(7972607).withFoliageColor(-5724026).withGrassColor(-5724026).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(DreadSandBlock.block.getDefaultState(),
								DreadRockBlock.block.getDefaultState(), DreadRockBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("blahmod:dread"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("dread_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("dread_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
