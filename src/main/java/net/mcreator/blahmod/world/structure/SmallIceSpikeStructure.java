...
public class SmallIceSpikeStructure extends BlahmodModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public SmallIceSpikeStructure(BlahmodModElements instance) {
		super(instance, 1543);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("small_ice_spike"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:small_ice_spike"), configuredFeature);
		}
	}
	@SubscribeEvent
