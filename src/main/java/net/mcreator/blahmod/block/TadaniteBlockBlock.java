...
public class TadaniteBlockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tadanite_block")
	public static final Block block = null;
	public TadaniteBlockBlock(BlahmodModElements instance) {
		super(instance, 259);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.STONE).hardnessAndResistance(20f, 2000f).setLightLevel(s -> 0)
					.harvestLevel(3).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("tadanite_block");
		}
