...
public class DreadRockBricksBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_rock_bricks")
	public static final Block block = null;
	public DreadRockBricksBlock(BlahmodModElements instance) {
		super(instance, 275);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dread_rock_bricks");
		}
