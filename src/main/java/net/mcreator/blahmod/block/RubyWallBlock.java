...
public class RubyWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ruby_wall")
	public static final Block block = null;
	public RubyWallBlock(BlahmodModElements instance) {
		super(instance, 429);
	}
