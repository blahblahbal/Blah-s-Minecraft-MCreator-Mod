...
public class Bedrock2Block extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:bedrock_2")
	public static final Block block = null;
	public Bedrock2Block(BlahmodModElements instance) {
		super(instance, 782);
	}
