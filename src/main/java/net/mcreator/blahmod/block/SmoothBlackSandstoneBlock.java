...
public class SmoothBlackSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:smooth_black_sandstone")
	public static final Block block = null;
	public SmoothBlackSandstoneBlock(BlahmodModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_black_sandstone");
		}
