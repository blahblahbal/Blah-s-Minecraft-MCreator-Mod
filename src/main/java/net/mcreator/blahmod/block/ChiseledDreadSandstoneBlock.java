...
public class ChiseledDreadSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:chiseled_dread_sandstone")
	public static final Block block = null;
	public ChiseledDreadSandstoneBlock(BlahmodModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_dread_sandstone");
		}
