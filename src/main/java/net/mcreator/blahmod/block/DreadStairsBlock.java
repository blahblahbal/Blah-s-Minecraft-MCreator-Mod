...
public class DreadStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_stairs")
	public static final Block block = null;
	public DreadStairsBlock(BlahmodModElements instance) {
		super(instance, 57);
	}
