...
public class DarkMatterSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dark_matter_secret_door")
	public static final Block block = null;
	public DarkMatterSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 390);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_matter_secret_door");
		}
