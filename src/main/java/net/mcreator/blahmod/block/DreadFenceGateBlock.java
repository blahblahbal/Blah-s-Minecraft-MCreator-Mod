...
public class DreadFenceGateBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_fence_gate")
	public static final Block block = null;
	public DreadFenceGateBlock(BlahmodModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dread_fence_gate");
		}
