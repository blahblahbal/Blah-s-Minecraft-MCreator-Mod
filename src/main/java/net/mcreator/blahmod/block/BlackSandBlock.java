...
public class BlackSandBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:black_sand")
	public static final Block block = null;
	public BlackSandBlock(BlahmodModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends FallingBlock implements IGrowable {
		public CustomBlock() {
			super(Block.Properties.create(Material.SAND).sound(SoundType.SAND).hardnessAndResistance(0.5f, 0.5f).harvestTool(ToolType.SHOVEL).setLightLevel(s -> 0));
