...
public class CutRedSandstoneStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_red_sandstone_stairs")
	public static final Block block = null;
	public CutRedSandstoneStairsBlock(BlahmodModElements instance) {
		super(instance, 1281);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(0.8f, 0.8f)).getDefaultState(),
			...
			setRegistryName("cut_red_sandstone_stairs");
		}
