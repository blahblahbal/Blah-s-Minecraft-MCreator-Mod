...
public class DiamondSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:diamond_side_slab")
	public static final Block block = null;
	public DiamondSideSlabBlock(BlahmodModElements instance) {
		super(instance, 753);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("diamond_side_slab");
		}
