...
public class PolishedLightlyCharredScoriaSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_lightly_charred_scoria_side_slab")
	public static final Block block = null;
	public PolishedLightlyCharredScoriaSideSlabBlock(BlahmodModElements instance) {
		super(instance, 493);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("polished_lightly_charred_scoria_side_slab");
		}
