...
public class DreadSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_sandstone")
	public static final Block block = null;
	public DreadSandstoneBlock(BlahmodModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dread_sandstone");
		}
