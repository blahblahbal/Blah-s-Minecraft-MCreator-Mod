...
public class ShroomTallGrassBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:shroom_tall_grass")
	public static final Block block = null;
	public ShroomTallGrassBlock(BlahmodModElements instance) {
		super(instance, 502);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("shroom_tall_grass");
		}
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (block == ShroomGrassBlock.block.getDefaultState().getBlock());
		}
