...
public class DiamondLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:diamond_leaves")
	public static final Block block = null;
	public DiamondLeavesBlock(BlahmodModElements instance) {
		super(instance, 456);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("diamond_leaves");
		}
