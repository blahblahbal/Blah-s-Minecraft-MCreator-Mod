...
public class DreadDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_door")
	public static final Block block = null;
	public DreadDoorBlock(BlahmodModElements instance) {
		super(instance, 169);
	}
