...
public class EtherealWoodBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_wood")
	public static final Block block = null;
	public EtherealWoodBlock(BlahmodModElements instance) {
		super(instance, 1794);
	}
