...
public class CloudStoneBrickSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cloud_stone_brick_slab")
	public static final Block block = null;
	public CloudStoneBrickSlabBlock(BlahmodModElements instance) {
		super(instance, 312);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cloud_stone_brick_slab");
		}
