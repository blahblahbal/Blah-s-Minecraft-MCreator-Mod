...
public class SmoothBonesandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:smooth_bonesandstone")
	public static final Block block = null;
	public SmoothBonesandstoneBlock(BlahmodModElements instance) {
		super(instance, 143);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_bonesandstone");
		}
