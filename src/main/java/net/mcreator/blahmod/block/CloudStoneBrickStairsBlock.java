...
public class CloudStoneBrickStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cloud_stone_brick_stairs")
	public static final Block block = null;
	public CloudStoneBrickStairsBlock(BlahmodModElements instance) {
		super(instance, 398);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cloud_stone_brick_stairs");
		}
