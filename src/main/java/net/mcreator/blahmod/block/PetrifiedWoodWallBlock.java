...
public class PetrifiedWoodWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:petrified_wood_wall")
	public static final Block block = null;
	public PetrifiedWoodWallBlock(BlahmodModElements instance) {
		super(instance, 419);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("petrified_wood_wall");
		}
