...
public class GlowShroomBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:glow_shroom")
	public static final Block block = null;
	public GlowShroomBlock(BlahmodModElements instance) {
		super(instance, 501);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (block == ShroomGrassBlock.block.getDefaultState().getBlock() || block == ShroomMudBlock.block.getDefaultState().getBlock()
					|| block == Blocks.STONE.getDefaultState().getBlock());
		}
