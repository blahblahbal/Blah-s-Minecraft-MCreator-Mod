...
public class CharredScoriaBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:charred_scoria")
	public static final Block block = null;
	public CharredScoriaBlock(BlahmodModElements instance) {
		super(instance, 472);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("charred_scoria");
		}
