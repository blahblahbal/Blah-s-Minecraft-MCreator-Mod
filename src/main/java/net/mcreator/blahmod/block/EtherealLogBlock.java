...
public class EtherealLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_log")
	public static final Block block = null;
	public EtherealLogBlock(BlahmodModElements instance) {
		super(instance, 1793);
	}
