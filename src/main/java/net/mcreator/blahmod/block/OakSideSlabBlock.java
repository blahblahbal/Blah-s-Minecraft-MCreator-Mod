...
public class OakSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:oak_side_slab")
	public static final Block block = null;
	public OakSideSlabBlock(BlahmodModElements instance) {
		super(instance, 759);
	}
