...
public class TadaniteSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tadanite_slab")
	public static final Block block = null;
	public TadaniteSlabBlock(BlahmodModElements instance) {
		super(instance, 310);
	}
