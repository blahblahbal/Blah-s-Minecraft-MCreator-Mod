...
public class DreadRockBrickStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_rock_brick_stairs")
	public static final Block block = null;
	public DreadRockBrickStairsBlock(BlahmodModElements instance) {
		super(instance, 413);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dread_rock_brick_stairs");
		}
