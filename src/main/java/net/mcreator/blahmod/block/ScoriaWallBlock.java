...
public class ScoriaWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:scoria_wall")
	public static final Block block = null;
	public ScoriaWallBlock(BlahmodModElements instance) {
		super(instance, 467);
	}
