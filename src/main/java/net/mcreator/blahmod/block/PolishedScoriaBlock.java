...
public class PolishedScoriaBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_scoria")
	public static final Block block = null;
	public PolishedScoriaBlock(BlahmodModElements instance) {
		super(instance, 468);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_scoria");
		}
