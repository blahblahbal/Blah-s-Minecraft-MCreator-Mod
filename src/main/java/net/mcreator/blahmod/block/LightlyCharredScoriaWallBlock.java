...
public class LightlyCharredScoriaWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lightly_charred_scoria_wall")
	public static final Block block = null;
	public LightlyCharredScoriaWallBlock(BlahmodModElements instance) {
		super(instance, 483);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("lightly_charred_scoria_wall");
		}
