...
public class MossyEndStoneBrickWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:mossy_end_stone_brick_wall")
	public static final Block block = null;
	public MossyEndStoneBrickWallBlock(BlahmodModElements instance) {
		super(instance, 437);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_end_stone_brick_wall");
		}
