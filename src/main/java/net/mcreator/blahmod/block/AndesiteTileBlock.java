...
public class AndesiteTileBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:andesite_tile")
	public static final Block block = null;
	public AndesiteTileBlock(BlahmodModElements instance) {
		super(instance, 108);
	}
