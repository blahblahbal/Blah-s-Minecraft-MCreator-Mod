...
public class SmoothDreadSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:smooth_dread_sandstone")
	public static final Block block = null;
	public SmoothDreadSandstoneBlock(BlahmodModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_dread_sandstone");
		}
