...
public class TropicsTrapdoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_trapdoor")
	public static final Block block = null;
	public TropicsTrapdoorBlock(BlahmodModElements instance) {
		super(instance, 247);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("tropics_trapdoor");
		}
