...
public class LightlyCharredScoriaStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lightly_charred_scoria_stairs")
	public static final Block block = null;
	public LightlyCharredScoriaStairsBlock(BlahmodModElements instance) {
		super(instance, 481);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lightly_charred_scoria_stairs");
		}
