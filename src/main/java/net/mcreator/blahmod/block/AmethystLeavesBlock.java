...
public class AmethystLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:amethyst_leaves")
	public static final Block block = null;
	public AmethystLeavesBlock(BlahmodModElements instance) {
		super(instance, 458);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("amethyst_leaves");
		}
