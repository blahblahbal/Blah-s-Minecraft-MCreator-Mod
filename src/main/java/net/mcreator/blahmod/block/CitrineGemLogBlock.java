...
public class CitrineGemLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:citrine_gem_log")
	public static final Block block = null;
	public CitrineGemLogBlock(BlahmodModElements instance) {
		super(instance, 446);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("citrine_gem_log");
		}
