...
public class CactusSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cactus_side_slab")
	public static final Block block = null;
	public CactusSideSlabBlock(BlahmodModElements instance) {
		super(instance, 975);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 6f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.AXE).notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("cactus_side_slab");
		}
