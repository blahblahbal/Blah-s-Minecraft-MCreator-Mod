...
public class EtherealDirtBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_dirt")
	public static final Block block = null;
	public EtherealDirtBlock(BlahmodModElements instance) {
		super(instance, 1816);
	}
	...
	public static class CustomBlock extends Block implements IGrowable {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(0.8f, 2f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.SHOVEL));
			setRegistryName("ethereal_dirt");
		}
