...
public class DreadWoodBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_wood")
	public static final Block block = null;
	public DreadWoodBlock(BlahmodModElements instance) {
		super(instance, 53);
	}
