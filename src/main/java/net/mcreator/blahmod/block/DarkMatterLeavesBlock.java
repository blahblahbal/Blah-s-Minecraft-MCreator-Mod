...
import net.mcreator.blahmod.procedures.DarkMatterLeavesBrokenProcedure;
...
public class DarkMatterLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dark_matter_leaves")
	public static final Block block = null;
	public DarkMatterLeavesBlock(BlahmodModElements instance) {
		super(instance, 197);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.2f, 0.2f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool().notSolid());
			setRegistryName("dark_matter_leaves");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				DarkMatterLeavesBrokenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
