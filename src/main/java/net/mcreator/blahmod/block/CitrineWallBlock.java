...
public class CitrineWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:citrine_wall")
	public static final Block block = null;
	public CitrineWallBlock(BlahmodModElements instance) {
		super(instance, 430);
	}
