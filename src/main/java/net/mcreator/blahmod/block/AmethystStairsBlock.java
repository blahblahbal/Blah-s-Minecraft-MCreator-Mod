...
public class AmethystStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:amethyst_stairs")
	public static final Block block = null;
	public AmethystStairsBlock(BlahmodModElements instance) {
		super(instance, 409);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("amethyst_stairs");
		}
