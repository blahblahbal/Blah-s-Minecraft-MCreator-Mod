...
public class CutBlackSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_black_sandstone")
	public static final Block block = null;
	public CutBlackSandstoneBlock(BlahmodModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_black_sandstone");
		}
