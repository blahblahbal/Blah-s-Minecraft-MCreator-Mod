...
public class DreadFenceBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_fence")
	public static final Block block = null;
	public DreadFenceBlock(BlahmodModElements instance) {
		super(instance, 59);
	}
