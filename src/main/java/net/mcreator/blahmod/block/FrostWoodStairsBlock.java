...
public class FrostWoodStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_wood_stairs")
	public static final Block block = null;
	public FrostWoodStairsBlock(BlahmodModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("frost_wood_stairs");
		}
