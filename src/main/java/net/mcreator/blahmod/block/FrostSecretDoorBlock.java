...
public class FrostSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_secret_door")
	public static final Block block = null;
	public FrostSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 356);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frost_secret_door");
		}
