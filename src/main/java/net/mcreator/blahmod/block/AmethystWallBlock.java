...
public class AmethystWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:amethyst_wall")
	public static final Block block = null;
	public AmethystWallBlock(BlahmodModElements instance) {
		super(instance, 435);
	}
