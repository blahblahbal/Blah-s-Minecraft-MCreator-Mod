...
public class EtherealTallGrassBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_tall_grass")
	public static final Block block = null;
	public EtherealTallGrassBlock(BlahmodModElements instance) {
		super(instance, 534);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ethereal_tall_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:ethereal_tall_grass"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("ethereal_tall_grass");
		}
