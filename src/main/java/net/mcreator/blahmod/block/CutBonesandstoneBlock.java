...
public class CutBonesandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_bonesandstone")
	public static final Block block = null;
	public CutBonesandstoneBlock(BlahmodModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_bonesandstone");
		}
