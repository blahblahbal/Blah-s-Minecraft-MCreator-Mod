...
public class PolishedLightlyCharredScoriaWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_lightly_charred_scoria_wall")
	public static final Block block = null;
	public PolishedLightlyCharredScoriaWallBlock(BlahmodModElements instance) {
		super(instance, 487);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_lightly_charred_scoria_wall");
		}
