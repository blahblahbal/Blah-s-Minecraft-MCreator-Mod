...
public class DiamondWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:diamond_wall")
	public static final Block block = null;
	public DiamondWallBlock(BlahmodModElements instance) {
		super(instance, 533);
	}
