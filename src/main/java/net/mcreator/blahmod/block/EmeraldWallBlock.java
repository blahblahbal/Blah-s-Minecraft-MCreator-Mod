...
public class EmeraldWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:emerald_wall")
	public static final Block block = null;
	public EmeraldWallBlock(BlahmodModElements instance) {
		super(instance, 532);
	}
