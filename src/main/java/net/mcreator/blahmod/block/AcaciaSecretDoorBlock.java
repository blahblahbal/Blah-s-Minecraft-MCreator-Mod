...
public class AcaciaSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:acacia_secret_door")
	public static final Block block = null;
	public AcaciaSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 1059);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("acacia_secret_door");
		}
