...
public class GemLogNoGemBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:gem_log_no_gem")
	public static final Block block = null;
	public GemLogNoGemBlock(BlahmodModElements instance) {
		super(instance, 444);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("gem_log_no_gem");
		}
