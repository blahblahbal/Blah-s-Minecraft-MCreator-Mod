...
public class TropicsSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_secret_door")
	public static final Block block = null;
	public TropicsSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 383);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tropics_secret_door");
		}
