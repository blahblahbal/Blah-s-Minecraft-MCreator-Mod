...
public class BonesandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:bonesandstone")
	public static final Block block = null;
	public BonesandstoneBlock(BlahmodModElements instance) {
		super(instance, 140);
	}
