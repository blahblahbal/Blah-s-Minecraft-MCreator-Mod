...
public class CactusSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cactus_secret_door")
	public static final Block block = null;
	public CactusSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 386);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cactus_secret_door");
		}
