...
public class CementStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cement_stairs")
	public static final Block block = null;
	public CementStairsBlock(BlahmodModElements instance) {
		super(instance, 410);
	}
