...
public class DreadTrapdoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_trapdoor")
	public static final Block block = null;
	public DreadTrapdoorBlock(BlahmodModElements instance) {
		super(instance, 246);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dread_trapdoor");
		}
