...
public class MagmaRockBrickStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:magma_rock_brick_stairs")
	public static final Block block = null;
	public MagmaRockBrickStairsBlock(BlahmodModElements instance) {
		super(instance, 400);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("magma_rock_brick_stairs");
		}
