...
public class ChiseledFrostSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:chiseled_frost_sandstone")
	public static final Block block = null;
	public ChiseledFrostSandstoneBlock(BlahmodModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_frost_sandstone");
		}
