...
public class CitrineLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:citrine_leaves")
	public static final Block block = null;
	public CitrineLeavesBlock(BlahmodModElements instance) {
		super(instance, 453);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("citrine_leaves");
		}
