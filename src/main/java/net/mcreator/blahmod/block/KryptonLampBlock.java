...
public class KryptonLampBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:krypton_lamp")
	public static final Block block = null;
	public KryptonLampBlock(BlahmodModElements instance) {
		super(instance, 517);
	}
