...
public class LumiteStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lumite_stairs")
	public static final Block block = null;
	public LumiteStairsBlock(BlahmodModElements instance) {
		super(instance, 399);
	}
