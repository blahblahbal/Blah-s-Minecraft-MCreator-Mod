...
public class PlayerPistonBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:player_piston")
	public static final Block block = null;
	public PlayerPistonBlock(BlahmodModElements instance) {
		super(instance, 439);
	}
