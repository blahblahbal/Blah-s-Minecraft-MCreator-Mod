...
public class PolishedScoriaSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_scoria_slab")
	public static final Block block = null;
	public PolishedScoriaSlabBlock(BlahmodModElements instance) {
		super(instance, 470);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_scoria_slab");
		}
