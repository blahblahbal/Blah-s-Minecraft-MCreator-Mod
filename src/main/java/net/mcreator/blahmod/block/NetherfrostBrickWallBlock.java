...
public class NetherfrostBrickWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:netherfrost_brick_wall")
	public static final Block block = null;
	public NetherfrostBrickWallBlock(BlahmodModElements instance) {
		super(instance, 421);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("netherfrost_brick_wall");
		}
