...
public class RubyLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ruby_leaves")
	public static final Block block = null;
	public RubyLeavesBlock(BlahmodModElements instance) {
		super(instance, 452);
	}
