...
public class PolishedNetherrackSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_netherrack_slab")
	public static final Block block = null;
	public PolishedNetherrackSlabBlock(BlahmodModElements instance) {
		super(instance, 506);
	}
