...
public class SideSlabTestBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:side_slab_test")
	public static final Block block = null;
	public SideSlabTestBlock(BlahmodModElements instance) {
		super(instance, 324);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("side_slab_test");
		}
