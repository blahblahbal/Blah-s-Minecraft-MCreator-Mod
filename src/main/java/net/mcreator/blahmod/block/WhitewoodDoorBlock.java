...
public class WhitewoodDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:whitewood_door")
	public static final Block block = null;
	public WhitewoodDoorBlock(BlahmodModElements instance) {
		super(instance, 1320);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("whitewood_door");
		}
