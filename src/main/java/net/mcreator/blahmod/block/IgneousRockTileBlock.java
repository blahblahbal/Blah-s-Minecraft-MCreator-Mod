...
public class IgneousRockTileBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:igneous_rock_tile")
	public static final Block block = null;
	public IgneousRockTileBlock(BlahmodModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("igneous_rock_tile");
		}
