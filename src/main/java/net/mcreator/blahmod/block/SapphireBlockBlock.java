...
public class SapphireBlockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sapphire_block")
	public static final Block block = null;
	public SapphireBlockBlock(BlahmodModElements instance) {
		super(instance, 270);
	}
