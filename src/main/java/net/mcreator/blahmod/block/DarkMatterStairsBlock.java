...
public class DarkMatterStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dark_matter_stairs")
	public static final Block block = null;
	public DarkMatterStairsBlock(BlahmodModElements instance) {
		super(instance, 211);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_matter_stairs");
		}
