...
public class KryptonCrystalOreBlock extends BlahmodModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("blahmod:krypton_crystal_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("krypton_crystal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:krypton_crystal_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
