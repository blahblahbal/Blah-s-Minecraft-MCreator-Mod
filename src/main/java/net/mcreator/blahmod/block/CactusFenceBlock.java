...
public class CactusFenceBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cactus_fence")
	public static final Block block = null;
	public CactusFenceBlock(BlahmodModElements instance) {
		super(instance, 226);
	}
