...
public class PetrifiedPlanksSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:petrified_planks_side_slab")
	public static final Block block = null;
	public PetrifiedPlanksSideSlabBlock(BlahmodModElements instance) {
		super(instance, 364);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.STONE).hardnessAndResistance(1.4f, 3f).setLightLevel(s -> 0).harvestLevel(-1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("petrified_planks_side_slab");
		}
