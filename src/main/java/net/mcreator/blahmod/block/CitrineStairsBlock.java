...
public class CitrineStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:citrine_stairs")
	public static final Block block = null;
	public CitrineStairsBlock(BlahmodModElements instance) {
		super(instance, 404);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("citrine_stairs");
		}
