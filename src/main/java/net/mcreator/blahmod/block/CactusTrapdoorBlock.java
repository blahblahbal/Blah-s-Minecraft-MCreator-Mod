...
public class CactusTrapdoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cactus_trapdoor")
	public static final Block block = null;
	public CactusTrapdoorBlock(BlahmodModElements instance) {
		super(instance, 252);
	}
