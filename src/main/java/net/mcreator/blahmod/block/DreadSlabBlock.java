...
public class DreadSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_slab")
	public static final Block block = null;
	public DreadSlabBlock(BlahmodModElements instance) {
		super(instance, 58);
	}
