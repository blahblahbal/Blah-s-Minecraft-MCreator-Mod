...
public class CitrineBlockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:citrine_block")
	public static final Block block = null;
	public CitrineBlockBlock(BlahmodModElements instance) {
		super(instance, 268);
	}
