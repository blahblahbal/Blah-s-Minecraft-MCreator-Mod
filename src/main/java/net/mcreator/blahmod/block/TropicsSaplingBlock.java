...
import net.mcreator.blahmod.procedures.TropicsSaplingRClickedProcedure;
...
public class TropicsSaplingBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_sapling")
	public static final Block block = null;
	public TropicsSaplingBlock(BlahmodModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tropics_sapling");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				TropicsSaplingRClickedProcedure.executeProcedure($_dependencies);
			}
