...
public class BorderlessGlassBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:borderless_glass")
	public static final Block block = null;
	public BorderlessGlassBlock(BlahmodModElements instance) {
		super(instance, 258);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("borderless_glass");
		}

		@Override
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.737254901961f, 0.643137254902f, 0.58431372549f};
		}
