...
public class DreadRockBricksWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_rock_bricks_wall")
	public static final Block block = null;
	public DreadRockBricksWallBlock(BlahmodModElements instance) {
		super(instance, 424);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("dread_rock_bricks_wall");
		}
