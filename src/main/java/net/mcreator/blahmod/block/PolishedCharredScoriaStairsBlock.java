...
public class PolishedCharredScoriaStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_charred_scoria_stairs")
	public static final Block block = null;
	public PolishedCharredScoriaStairsBlock(BlahmodModElements instance) {
		super(instance, 477);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.BASALT).hardnessAndResistance(1.5f, 6f).setLightLevel(s -> 0)
			...
			setRegistryName("polished_charred_scoria_stairs");
		}
