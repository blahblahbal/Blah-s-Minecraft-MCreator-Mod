...
import net.mcreator.blahmod.procedures.CedarSaplingRClickedProcedure;
...
public class CedarSaplingBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cedar_sapling")
	public static final Block block = null;
	public CedarSaplingBlock(BlahmodModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				CedarSaplingRClickedProcedure.executeProcedure($_dependencies);
			}
