...
import net.mcreator.blahmod.procedures.CedarLeavesBrokenProcedure;
...
public class CedarLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cedar_leaves")
	public static final Block block = null;
	public CedarLeavesBlock(BlahmodModElements instance) {
		super(instance, 195);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				CedarLeavesBrokenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
