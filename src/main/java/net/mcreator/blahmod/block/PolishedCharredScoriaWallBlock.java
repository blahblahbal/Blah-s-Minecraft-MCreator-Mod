...
public class PolishedCharredScoriaWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_charred_scoria_wall")
	public static final Block block = null;
	public PolishedCharredScoriaWallBlock(BlahmodModElements instance) {
		super(instance, 479);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_charred_scoria_wall");
		}
