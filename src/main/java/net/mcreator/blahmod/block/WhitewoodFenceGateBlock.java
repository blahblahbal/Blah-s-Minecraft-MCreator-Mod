...
public class WhitewoodFenceGateBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:whitewood_fence_gate")
	public static final Block block = null;
	public WhitewoodFenceGateBlock(BlahmodModElements instance) {
		super(instance, 1300);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("whitewood_fence_gate");
		}
