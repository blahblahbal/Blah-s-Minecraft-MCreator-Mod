...
public class CutDreadSandstoneSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_dread_sandstone_slab")
	public static final Block block = null;
	public CutDreadSandstoneSlabBlock(BlahmodModElements instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cut_dread_sandstone_slab");
		}
