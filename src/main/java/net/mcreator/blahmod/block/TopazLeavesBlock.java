...
public class TopazLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:topaz_leaves")
	public static final Block block = null;
	public TopazLeavesBlock(BlahmodModElements instance) {
		super(instance, 454);
	}
