...
public class WebstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:webstone")
	public static final Block block = null;
	public WebstoneBlock(BlahmodModElements instance) {
		super(instance, 496);
	}
