...
public class CutDreadSandstoneStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_dread_sandstone_stairs")
	public static final Block block = null;
	public CutDreadSandstoneStairsBlock(BlahmodModElements instance) {
		super(instance, 394);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cut_dread_sandstone_stairs");
		}
