...
public class EtherealSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_slab")
	public static final Block block = null;
	public EtherealSlabBlock(BlahmodModElements instance) {
		super(instance, 1879);
	}
