...
public class AmethystSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:amethyst_side_slab")
	public static final Block block = null;
	public AmethystSideSlabBlock(BlahmodModElements instance) {
		super(instance, 336);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("amethyst_side_slab");
		}
