...
public class SapphireGemLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sapphire_gem_log")
	public static final Block block = null;
	public SapphireGemLogBlock(BlahmodModElements instance) {
		super(instance, 450);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sapphire_gem_log");
		}
