...
public class FrostSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_sandstone")
	public static final Block block = null;
	public FrostSandstoneBlock(BlahmodModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frost_sandstone");
		}
