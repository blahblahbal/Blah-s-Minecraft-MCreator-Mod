...
public class EtherealPlanksBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_planks")
	public static final Block block = null;
	public EtherealPlanksBlock(BlahmodModElements instance) {
		super(instance, 1877);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ethereal_planks");
		}
