...
public class PolishedLightlyCharredScoriaBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_lightly_charred_scoria")
	public static final Block block = null;
	public PolishedLightlyCharredScoriaBlock(BlahmodModElements instance) {
		super(instance, 484);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_lightly_charred_scoria");
		}
