...
public class CementWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cement_wall")
	public static final Block block = null;
	public CementWallBlock(BlahmodModElements instance) {
		super(instance, 423);
	}
