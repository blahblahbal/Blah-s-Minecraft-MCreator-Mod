...
public class WhitewoodWoodBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:whitewood_wood")
	public static final Block block = null;
	public WhitewoodWoodBlock(BlahmodModElements instance) {
		super(instance, 1304);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("whitewood_wood");
		}
