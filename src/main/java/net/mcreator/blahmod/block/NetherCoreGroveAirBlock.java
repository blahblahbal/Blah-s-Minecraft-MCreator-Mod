...
public class NetherCoreGroveAirBlock extends BlahmodModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				NetherCoreGroveAirProProcedure.executeProcedure($_dependencies);
			}
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("blahmod:nether_core_grove_air_match"),
