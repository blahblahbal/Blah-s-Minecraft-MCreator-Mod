...
public class CutFrostSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_frost_sandstone")
	public static final Block block = null;
	public CutFrostSandstoneBlock(BlahmodModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_frost_sandstone");
		}
