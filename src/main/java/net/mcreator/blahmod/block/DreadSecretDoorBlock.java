...
public class DreadSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_secret_door")
	public static final Block block = null;
	public DreadSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 359);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dread_secret_door");
		}
