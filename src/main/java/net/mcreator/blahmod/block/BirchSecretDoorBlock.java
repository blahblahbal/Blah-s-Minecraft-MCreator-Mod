...
public class BirchSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:birch_secret_door")
	public static final Block block = null;
	public BirchSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 1061);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("birch_secret_door");
		}
