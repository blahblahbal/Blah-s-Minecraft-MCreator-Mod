...
public class CobblestoneDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cobblestone_door")
	public static final Block block = null;
	public CobblestoneDoorBlock(BlahmodModElements instance) {
		super(instance, 172);
	}
