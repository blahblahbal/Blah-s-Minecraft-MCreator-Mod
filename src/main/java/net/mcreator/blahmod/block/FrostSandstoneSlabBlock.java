...
public class FrostSandstoneSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_sandstone_slab")
	public static final Block block = null;
	public FrostSandstoneSlabBlock(BlahmodModElements instance) {
		super(instance, 296);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("frost_sandstone_slab");
		}
