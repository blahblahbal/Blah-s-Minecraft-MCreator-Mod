...
public class CactusStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cactus_stairs")
	public static final Block block = null;
	public CactusStairsBlock(BlahmodModElements instance) {
		super(instance, 212);
	}
