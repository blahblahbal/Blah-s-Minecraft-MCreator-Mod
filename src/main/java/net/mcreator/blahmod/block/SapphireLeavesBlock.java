...
public class SapphireLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sapphire_leaves")
	public static final Block block = null;
	public SapphireLeavesBlock(BlahmodModElements instance) {
		super(instance, 457);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("sapphire_leaves");
		}
