...
public class TropicsStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_stairs")
	public static final Block block = null;
	public TropicsStairsBlock(BlahmodModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tropics_stairs");
		}
