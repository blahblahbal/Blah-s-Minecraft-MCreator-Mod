...
public class DreadLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_leaves")
	public static final Block block = null;
	public DreadLeavesBlock(BlahmodModElements instance) {
		super(instance, 192);
	}
