...
public class RubySideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ruby_side_slab")
	public static final Block block = null;
	public RubySideSlabBlock(BlahmodModElements instance) {
		super(instance, 330);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("ruby_side_slab");
		}
