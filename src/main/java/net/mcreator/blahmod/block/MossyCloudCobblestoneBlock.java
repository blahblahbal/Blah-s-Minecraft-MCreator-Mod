...
public class MossyCloudCobblestoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:mossy_cloud_cobblestone")
	public static final Block block = null;
	public MossyCloudCobblestoneBlock(BlahmodModElements instance) {
		super(instance, 1934);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_cloud_cobblestone");
		}
