...
public class TropicsFenceGateBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_fence_gate")
	public static final Block block = null;
	public TropicsFenceGateBlock(BlahmodModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("tropics_fence_gate");
		}
