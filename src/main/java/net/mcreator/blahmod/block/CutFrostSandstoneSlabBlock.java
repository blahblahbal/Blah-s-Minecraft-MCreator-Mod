...
public class CutFrostSandstoneSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_frost_sandstone_slab")
	public static final Block block = null;
	public CutFrostSandstoneSlabBlock(BlahmodModElements instance) {
		super(instance, 300);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cut_frost_sandstone_slab");
		}
