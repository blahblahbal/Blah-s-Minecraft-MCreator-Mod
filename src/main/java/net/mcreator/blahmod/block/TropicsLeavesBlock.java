...
import net.mcreator.blahmod.procedures.TropicsLeavesBrokenProcedure;
...
public class TropicsLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_leaves")
	public static final Block block = null;
	public TropicsLeavesBlock(BlahmodModElements instance) {
		super(instance, 193);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("tropics_leaves");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				TropicsLeavesBrokenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
