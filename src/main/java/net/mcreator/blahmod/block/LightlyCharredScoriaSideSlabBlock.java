...
public class LightlyCharredScoriaSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lightly_charred_scoria_side_slab")
	public static final Block block = null;
	public LightlyCharredScoriaSideSlabBlock(BlahmodModElements instance) {
		super(instance, 492);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("lightly_charred_scoria_side_slab");
		}
