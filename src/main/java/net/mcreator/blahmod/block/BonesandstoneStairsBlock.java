...
public class BonesandstoneStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:bonesandstone_stairs")
	public static final Block block = null;
	public BonesandstoneStairsBlock(BlahmodModElements instance) {
		super(instance, 397);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bonesandstone_stairs");
		}
