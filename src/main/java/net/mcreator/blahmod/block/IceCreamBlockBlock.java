...
public class IceCreamBlockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ice_cream_block")
	public static final Block block = null;
	public IceCreamBlockBlock(BlahmodModElements instance) {
		super(instance, 462);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 7f).setLightLevel(s -> 4).harvestLevel(0)
