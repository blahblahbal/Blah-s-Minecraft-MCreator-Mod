...
public class ImperviousBrickWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:impervious_brick_wall")
	public static final Block block = null;
	public ImperviousBrickWallBlock(BlahmodModElements instance) {
		super(instance, 425);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("impervious_brick_wall");
		}
