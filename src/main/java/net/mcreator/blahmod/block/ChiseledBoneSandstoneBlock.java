...
public class ChiseledBoneSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:chiseled_bone_sandstone")
	public static final Block block = null;
	public ChiseledBoneSandstoneBlock(BlahmodModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_bone_sandstone");
		}
