...
public class TopazGemLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:topaz_gem_log")
	public static final Block block = null;
	public TopazGemLogBlock(BlahmodModElements instance) {
		super(instance, 447);
	}
