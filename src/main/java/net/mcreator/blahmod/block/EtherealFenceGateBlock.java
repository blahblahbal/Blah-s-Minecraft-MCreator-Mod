...
public class EtherealFenceGateBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_fence_gate")
	public static final Block block = null;
	public EtherealFenceGateBlock(BlahmodModElements instance) {
		super(instance, 1881);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ethereal_fence_gate");
		}
