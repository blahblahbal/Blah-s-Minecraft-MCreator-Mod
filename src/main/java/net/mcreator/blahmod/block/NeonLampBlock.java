...
public class NeonLampBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:neon_lamp")
	public static final Block block = null;
	public NeonLampBlock(BlahmodModElements instance) {
		super(instance, 518);
	}
