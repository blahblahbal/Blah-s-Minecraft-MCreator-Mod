...
import net.mcreator.blahmod.procedures.WhitewoodLeavesBrokenProcedure;
...
public class WhitewoodLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:whitewood_leaves")
	public static final Block block = null;
	public WhitewoodLeavesBlock(BlahmodModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("whitewood_leaves");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				WhitewoodLeavesBrokenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
