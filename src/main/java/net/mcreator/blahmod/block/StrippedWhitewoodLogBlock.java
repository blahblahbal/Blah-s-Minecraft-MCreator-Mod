...
public class StrippedWhitewoodLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:stripped_whitewood_log")
	public static final Block block = null;
	public StrippedWhitewoodLogBlock(BlahmodModElements instance) {
		super(instance, 1294);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_whitewood_log");
		}
