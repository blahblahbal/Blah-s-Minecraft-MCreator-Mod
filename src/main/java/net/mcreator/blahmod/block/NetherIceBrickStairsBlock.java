...
public class NetherIceBrickStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:nether_ice_brick_stairs")
	public static final Block block = null;
	public NetherIceBrickStairsBlock(BlahmodModElements instance) {
		super(instance, 412);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(5f, 6f).setLightLevel(s -> 0)
					...
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(5f, 6f).setLightLevel(s -> 0).harvestLevel(0)
							.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("nether_ice_brick_stairs");
		}
