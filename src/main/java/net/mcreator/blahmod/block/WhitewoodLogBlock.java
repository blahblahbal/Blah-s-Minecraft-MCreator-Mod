...
public class WhitewoodLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:whitewood_log")
	public static final Block block = null;
	public WhitewoodLogBlock(BlahmodModElements instance) {
		super(instance, 1293);
	}
