...
public class LimestoneOreBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:limestone_ore")
	public static final Block block = null;
	public LimestoneOreBlock(BlahmodModElements instance) {
		super(instance, 144);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LimestoneItem.block, (int) (2)));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("blahmod:limestone_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:limestone_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
