...
public class ZirconSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:zircon_side_slab")
	public static final Block block = null;
	public ZirconSideSlabBlock(BlahmodModElements instance) {
		super(instance, 326);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("zircon_side_slab");
		}
