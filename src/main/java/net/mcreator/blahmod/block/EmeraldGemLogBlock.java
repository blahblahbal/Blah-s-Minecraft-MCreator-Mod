...
public class EmeraldGemLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:emerald_gem_log")
	public static final Block block = null;
	public EmeraldGemLogBlock(BlahmodModElements instance) {
		super(instance, 448);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("emerald_gem_log");
		}
