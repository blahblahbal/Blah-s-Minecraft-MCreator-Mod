...
public class CutSandstoneStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_sandstone_stairs")
	public static final Block block = null;
	public CutSandstoneStairsBlock(BlahmodModElements instance) {
		super(instance, 1280);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cut_sandstone_stairs");
		}
