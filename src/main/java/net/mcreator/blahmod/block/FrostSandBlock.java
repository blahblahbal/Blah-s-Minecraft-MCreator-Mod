...
public class FrostSandBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_sand")
	public static final Block block = null;
	public FrostSandBlock(BlahmodModElements instance) {
		super(instance, 198);
	}
	...
	public static class CustomBlock extends FallingBlock implements IGrowable {
		public CustomBlock() {
			super(Block.Properties.create(Material.SAND).sound(SoundType.SAND).hardnessAndResistance(0.5f, 0.5f).setLightLevel(s -> 0).harvestTool(ToolType.SHOVEL));
			setRegistryName("frost_sand");
		}
