...
public class CutBlackSandstoneStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_black_sandstone_stairs")
	public static final Block block = null;
	public CutBlackSandstoneStairsBlock(BlahmodModElements instance) {
		super(instance, 392);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cut_black_sandstone_stairs");
		}
