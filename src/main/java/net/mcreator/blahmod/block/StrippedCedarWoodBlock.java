...
public class StrippedCedarWoodBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:stripped_cedar_wood")
	public static final Block block = null;
	public StrippedCedarWoodBlock(BlahmodModElements instance) {
		super(instance, 1003);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_cedar_wood");
		}
