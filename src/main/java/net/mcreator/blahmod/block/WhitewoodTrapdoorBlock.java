...
public class WhitewoodTrapdoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:whitewood_trapdoor")
	public static final Block block = null;
	public WhitewoodTrapdoorBlock(BlahmodModElements instance) {
		super(instance, 1321);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("whitewood_trapdoor");
		}
