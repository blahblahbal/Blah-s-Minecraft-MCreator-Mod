...
public class TopazStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:topaz_stairs")
	public static final Block block = null;
	public TopazStairsBlock(BlahmodModElements instance) {
		super(instance, 405);
	}
