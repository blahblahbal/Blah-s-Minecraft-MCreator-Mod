...
public class CharredScoriaWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:charred_scoria_wall")
	public static final Block block = null;
	public CharredScoriaWallBlock(BlahmodModElements instance) {
		super(instance, 475);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("charred_scoria_wall");
		}
