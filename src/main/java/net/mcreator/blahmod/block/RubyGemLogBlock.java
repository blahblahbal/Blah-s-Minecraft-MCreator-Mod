...
public class RubyGemLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ruby_gem_log")
	public static final Block block = null;
	public RubyGemLogBlock(BlahmodModElements instance) {
		super(instance, 445);
	}
