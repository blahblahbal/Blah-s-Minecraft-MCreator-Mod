...
public class TropicsCobblestoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_cobblestone")
	public static final Block block = null;
	public TropicsCobblestoneBlock(BlahmodModElements instance) {
		super(instance, 123);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tropics_cobblestone");
		}
