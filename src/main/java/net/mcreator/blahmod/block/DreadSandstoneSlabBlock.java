...
public class DreadSandstoneSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_sandstone_slab")
	public static final Block block = null;
	public DreadSandstoneSlabBlock(BlahmodModElements instance) {
		super(instance, 295);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dread_sandstone_slab");
		}
