...
public class CedarStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cedar_stairs")
	public static final Block block = null;
	public CedarStairsBlock(BlahmodModElements instance) {
		super(instance, 101);
	}
