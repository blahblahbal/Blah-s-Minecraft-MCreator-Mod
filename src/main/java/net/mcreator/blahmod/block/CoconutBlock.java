...
public class CoconutBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:coconut")
	public static final Block block = null;
	public CoconutBlock(BlahmodModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(2.992, 2.992, 2.992, 12.992, 12.992, 12.992)).withOffset(offset.x, offset.y, offset.z);
		}
