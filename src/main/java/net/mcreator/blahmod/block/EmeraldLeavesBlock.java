...
public class EmeraldLeavesBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:emerald_leaves")
	public static final Block block = null;
	public EmeraldLeavesBlock(BlahmodModElements instance) {
		super(instance, 455);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("emerald_leaves");
		}
