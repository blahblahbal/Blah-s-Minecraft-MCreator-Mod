...
public class GoldSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:gold_side_slab")
	public static final Block block = null;
	public GoldSideSlabBlock(BlahmodModElements instance) {
		super(instance, 765);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("gold_side_slab");
		}
