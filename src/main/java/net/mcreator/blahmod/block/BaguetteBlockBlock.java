...
public class BaguetteBlockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:baguette_block")
	public static final Block block = null;
	public BaguetteBlockBlock(BlahmodModElements instance) {
		super(instance, 258);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("baguette_block");
		}
