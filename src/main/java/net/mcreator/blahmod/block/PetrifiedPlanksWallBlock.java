...
public class PetrifiedPlanksWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:petrified_planks_wall")
	public static final Block block = null;
	public PetrifiedPlanksWallBlock(BlahmodModElements instance) {
		super(instance, 420);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("petrified_planks_wall");
		}
