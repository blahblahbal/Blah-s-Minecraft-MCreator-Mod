...
public class DioriteTileBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:diorite_tile")
	public static final Block block = null;
	public DioriteTileBlock(BlahmodModElements instance) {
		super(instance, 109);
	}
