...
public class TopazWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:topaz_wall")
	public static final Block block = null;
	public TopazWallBlock(BlahmodModElements instance) {
		super(instance, 431);
	}
