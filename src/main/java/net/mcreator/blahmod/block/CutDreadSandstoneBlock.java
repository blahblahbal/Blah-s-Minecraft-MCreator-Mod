...
public class CutDreadSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_dread_sandstone")
	public static final Block block = null;
	public CutDreadSandstoneBlock(BlahmodModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_dread_sandstone");
		}
