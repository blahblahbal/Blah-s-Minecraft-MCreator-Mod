...
public class EtherealStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_stairs")
	public static final Block block = null;
	public EtherealStairsBlock(BlahmodModElements instance) {
		super(instance, 1878);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ethereal_stairs");
		}
