...
public class TropicsFenceBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_fence")
	public static final Block block = null;
	public TropicsFenceBlock(BlahmodModElements instance) {
		super(instance, 86);
	}
