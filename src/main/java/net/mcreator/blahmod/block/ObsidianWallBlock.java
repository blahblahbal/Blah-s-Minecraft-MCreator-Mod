...
public class ObsidianWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:obsidian_wall")
	public static final Block block = null;
	public ObsidianWallBlock(BlahmodModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(50f, 250f).setLightLevel(s -> 0).harvestLevel(0)
