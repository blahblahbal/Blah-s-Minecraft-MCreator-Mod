...
public class SmoothFrostSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:smooth_frost_sandstone")
	public static final Block block = null;
	public SmoothFrostSandstoneBlock(BlahmodModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_frost_sandstone");
		}
