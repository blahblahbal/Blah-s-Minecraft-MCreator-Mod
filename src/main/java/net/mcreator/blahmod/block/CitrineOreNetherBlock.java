...
public class CitrineOreNetherBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:citrine_ore_nether")
	public static final Block block = null;
	public CitrineOreNetherBlock(BlahmodModElements instance) {
		super(instance, 1897);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("citrine_ore_nether");
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("blahmod:citrine_ore_nether_match"),
			...
			event.getRegistry().register(feature.setRegistryName("citrine_ore_nether"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:citrine_ore_nether"), configuredFeature);
		}
	}
	@SubscribeEvent
