...
public class CactusPlanksBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cactus_planks")
	public static final Block block = null;
	public CactusPlanksBlock(BlahmodModElements instance) {
		super(instance, 166);
	}
