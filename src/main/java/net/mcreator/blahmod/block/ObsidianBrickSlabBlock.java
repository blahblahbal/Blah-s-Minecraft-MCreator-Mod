...
public class ObsidianBrickSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:obsidian_brick_slab")
	public static final Block block = null;
	public ObsidianBrickSlabBlock(BlahmodModElements instance) {
		super(instance, 322);
	}
