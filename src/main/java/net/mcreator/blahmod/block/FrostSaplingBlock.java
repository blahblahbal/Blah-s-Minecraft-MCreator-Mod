...
import net.mcreator.blahmod.procedures.FrostSaplingRClickedProcedure;
...
public class FrostSaplingBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_sapling")
	public static final Block block = null;
	public FrostSaplingBlock(BlahmodModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				FrostSaplingRClickedProcedure.executeProcedure($_dependencies);
			}
