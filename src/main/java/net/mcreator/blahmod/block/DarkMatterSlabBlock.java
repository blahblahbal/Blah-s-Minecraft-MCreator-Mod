...
public class DarkMatterSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dark_matter_slab")
	public static final Block block = null;
	public DarkMatterSlabBlock(BlahmodModElements instance) {
		super(instance, 218);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_matter_slab");
		}
