...
public class SulphurBlockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sulphur_block")
	public static final Block block = null;
	public SulphurBlockBlock(BlahmodModElements instance) {
		super(instance, 260);
	}
