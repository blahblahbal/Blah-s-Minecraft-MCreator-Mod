...
public class BlackSandstoneSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:black_sandstone_slab")
	public static final Block block = null;
	public BlackSandstoneSlabBlock(BlahmodModElements instance) {
		super(instance, 294);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_sandstone_slab");
		}
