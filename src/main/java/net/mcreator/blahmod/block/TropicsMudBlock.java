...
public class TropicsMudBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_mud")
	public static final Block block = null;
	public TropicsMudBlock(BlahmodModElements instance) {
		super(instance, 249);
	}
