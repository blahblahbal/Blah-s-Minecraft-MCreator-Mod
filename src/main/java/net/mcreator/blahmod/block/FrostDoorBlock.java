...
public class FrostDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_door")
	public static final Block block = null;
	public FrostDoorBlock(BlahmodModElements instance) {
		super(instance, 170);
	}
