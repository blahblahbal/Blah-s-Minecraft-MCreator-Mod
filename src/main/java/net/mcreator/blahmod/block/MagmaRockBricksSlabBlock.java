...
public class MagmaRockBricksSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:magma_rock_bricks_slab")
	public static final Block block = null;
	public MagmaRockBricksSlabBlock(BlahmodModElements instance) {
		super(instance, 320);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("magma_rock_bricks_slab");
		}
