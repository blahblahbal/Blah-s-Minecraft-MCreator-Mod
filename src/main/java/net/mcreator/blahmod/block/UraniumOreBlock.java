...
public class UraniumOreBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:uranium_ore")
	public static final Block block = null;
	public UraniumOreBlock(BlahmodModElements instance) {
		super(instance, 523);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BASALT).hardnessAndResistance(3f, 6f).setLightLevel(s -> 2).harvestLevel(3)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("blahmod:uranium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:uranium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
