...
public class DarkMatterPlanksBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dark_matter_planks")
	public static final Block block = null;
	public DarkMatterPlanksBlock(BlahmodModElements instance) {
		super(instance, 165);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_matter_planks");
		}
