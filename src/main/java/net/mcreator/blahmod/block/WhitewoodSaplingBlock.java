...
public class WhitewoodSaplingBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:whitewood_sapling")
	public static final Block block = null;
	public WhitewoodSaplingBlock(BlahmodModElements instance) {
		super(instance, 201);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whitewood_sapling");
		}
