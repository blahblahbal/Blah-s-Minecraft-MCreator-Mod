...
public class DreadSandBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_sand")
	public static final Block block = null;
	public DreadSandBlock(BlahmodModElements instance) {
		super(instance, 69);
	}
