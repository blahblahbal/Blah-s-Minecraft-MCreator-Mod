...
import net.mcreator.blahmod.procedures.DreadSaplingRClickedProcedure;
...
public class DreadSaplingBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_sapling")
	public static final Block block = null;
	public DreadSaplingBlock(BlahmodModElements instance) {
		super(instance, 199);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				DreadSaplingRClickedProcedure.executeProcedure($_dependencies);
			}
