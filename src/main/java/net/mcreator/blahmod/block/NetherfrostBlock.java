...
public class NetherfrostBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:netherfrost")
	public static final Block block = null;
	public NetherfrostBlock(BlahmodModElements instance) {
		super(instance, 82);
