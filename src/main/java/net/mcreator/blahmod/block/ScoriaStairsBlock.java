...
public class ScoriaStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:scoria_stairs")
	public static final Block block = null;
	public ScoriaStairsBlock(BlahmodModElements instance) {
		super(instance, 465);
	}
