...
public class StrippedFrostWoodBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:stripped_frost_wood")
	public static final Block block = null;
	public StrippedFrostWoodBlock(BlahmodModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_frost_wood");
		}
