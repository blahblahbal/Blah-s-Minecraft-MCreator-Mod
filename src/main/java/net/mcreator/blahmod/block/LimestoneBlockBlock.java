...
public class LimestoneBlockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:limestone_block")
	public static final Block block = null;
	public LimestoneBlockBlock(BlahmodModElements instance) {
		super(instance, 264);
	}
