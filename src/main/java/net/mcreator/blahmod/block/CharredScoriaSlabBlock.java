...
public class CharredScoriaSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:charred_scoria_slab")
	public static final Block block = null;
	public CharredScoriaSlabBlock(BlahmodModElements instance) {
		super(instance, 474);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("charred_scoria_slab");
		}
