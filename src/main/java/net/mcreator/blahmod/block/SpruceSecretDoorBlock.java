...
public class SpruceSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:spruce_secret_door")
	public static final Block block = null;
	public SpruceSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 1062);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spruce_secret_door");
		}
