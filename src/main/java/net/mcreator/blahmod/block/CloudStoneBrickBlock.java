...
public class CloudStoneBrickBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cloud_stone_brick")
	public static final Block block = null;
	public CloudStoneBrickBlock(BlahmodModElements instance) {
		super(instance, 277);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cloud_stone_brick");
		}
