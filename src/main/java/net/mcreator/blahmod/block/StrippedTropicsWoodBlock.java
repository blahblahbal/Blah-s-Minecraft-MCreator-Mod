...
public class StrippedTropicsWoodBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:stripped_tropics_wood")
	public static final Block block = null;
	public StrippedTropicsWoodBlock(BlahmodModElements instance) {
		super(instance, 1006);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_tropics_wood");
		}
