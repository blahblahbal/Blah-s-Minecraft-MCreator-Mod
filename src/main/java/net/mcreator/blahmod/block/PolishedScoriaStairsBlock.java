...
public class PolishedScoriaStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_scoria_stairs")
	public static final Block block = null;
	public PolishedScoriaStairsBlock(BlahmodModElements instance) {
		super(instance, 469);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_scoria_stairs");
		}
