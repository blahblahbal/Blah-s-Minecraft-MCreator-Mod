...
public class StrippedDreadLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:stripped_dread_log")
	public static final Block block = null;
	public StrippedDreadLogBlock(BlahmodModElements instance) {
		super(instance, 431);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_dread_log");
		}
