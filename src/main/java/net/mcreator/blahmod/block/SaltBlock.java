...
public class SaltBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:salt")
	public static final Block block = null;
	public SaltBlock(BlahmodModElements instance) {
		super(instance, 525);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BASALT).hardnessAndResistance(1.2f, 6f).setLightLevel(s -> 0).harvestLevel(0)
