...
public class ScoriaSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:scoria_slab")
	public static final Block block = null;
	public ScoriaSlabBlock(BlahmodModElements instance) {
		super(instance, 466);
	}
