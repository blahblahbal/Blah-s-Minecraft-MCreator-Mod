...
public class GraniteTileBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:granite_tile")
	public static final Block block = null;
	public GraniteTileBlock(BlahmodModElements instance) {
		super(instance, 110);
	}
