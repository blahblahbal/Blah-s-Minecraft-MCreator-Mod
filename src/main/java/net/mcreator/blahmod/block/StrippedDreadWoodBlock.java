...
public class StrippedDreadWoodBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:stripped_dread_wood")
	public static final Block block = null;
	public StrippedDreadWoodBlock(BlahmodModElements instance) {
		super(instance, 1005);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_dread_wood");
		}
