...
public class ScoriaSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:scoria_side_slab")
	public static final Block block = null;
	public ScoriaSideSlabBlock(BlahmodModElements instance) {
		super(instance, 488);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("scoria_side_slab");
		}
