...
public class LumiteWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lumite_wall")
	public static final Block block = null;
	public LumiteWallBlock(BlahmodModElements instance) {
		super(instance, 428);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(10f, 250f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("lumite_wall");
		}
