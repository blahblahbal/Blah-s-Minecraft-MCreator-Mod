...
public class CharredScoriaStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:charred_scoria_stairs")
	public static final Block block = null;
	public CharredScoriaStairsBlock(BlahmodModElements instance) {
		super(instance, 473);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("charred_scoria_stairs");
		}
