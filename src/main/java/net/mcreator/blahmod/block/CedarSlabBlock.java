...
public class CedarSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cedar_slab")
	public static final Block block = null;
	public CedarSlabBlock(BlahmodModElements instance) {
		super(instance, 102);
	}
