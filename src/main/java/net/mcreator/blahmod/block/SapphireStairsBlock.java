...
public class SapphireStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sapphire_stairs")
	public static final Block block = null;
	public SapphireStairsBlock(BlahmodModElements instance) {
		super(instance, 408);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("sapphire_stairs");
		}
