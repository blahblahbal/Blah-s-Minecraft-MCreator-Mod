...
public class DreadPlanksBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_planks")
	public static final Block block = null;
	public DreadPlanksBlock(BlahmodModElements instance) {
		super(instance, 55);
	}
