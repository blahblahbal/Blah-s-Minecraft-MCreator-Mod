...
public class ObsidianBrickStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:obsidian_brick_stairs")
	public static final Block block = null;
	public ObsidianBrickStairsBlock(BlahmodModElements instance) {
		super(instance, 402);
	}
