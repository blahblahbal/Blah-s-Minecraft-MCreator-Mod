...
public class MagnetiteTileBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:magnetite_tile")
	public static final Block block = null;
	public MagnetiteTileBlock(BlahmodModElements instance) {
		super(instance, 116);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("magnetite_tile");
		}
