...
public class DreadRockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_rock")
	public static final Block block = null;
	public DreadRockBlock(BlahmodModElements instance) {
		super(instance, 81);
	}
