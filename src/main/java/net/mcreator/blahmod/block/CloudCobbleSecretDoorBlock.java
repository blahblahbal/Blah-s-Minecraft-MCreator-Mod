...
public class CloudCobbleSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cloud_cobble_secret_door")
	public static final Block block = null;
	public CloudCobbleSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 388);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cloud_cobble_secret_door");
		}
