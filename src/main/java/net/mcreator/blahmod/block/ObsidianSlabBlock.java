...
public class ObsidianSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:obsidian_slab")
	public static final Block block = null;
	public ObsidianSlabBlock(BlahmodModElements instance) {
		super(instance, 628);
	}
