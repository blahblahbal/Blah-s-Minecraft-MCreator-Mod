...
public class WhitewoodSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:whitewood_slab")
	public static final Block block = null;
	public WhitewoodSlabBlock(BlahmodModElements instance) {
		super(instance, 1297);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("whitewood_slab");
		}
