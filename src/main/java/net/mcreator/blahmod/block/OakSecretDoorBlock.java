...
public class OakSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:oak_secret_door")
	public static final Block block = null;
	public OakSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 1057);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("oak_secret_door");
		}
