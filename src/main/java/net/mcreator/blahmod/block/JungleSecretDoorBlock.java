...
public class JungleSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:jungle_secret_door")
	public static final Block block = null;
	public JungleSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 1060);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jungle_secret_door");
		}
