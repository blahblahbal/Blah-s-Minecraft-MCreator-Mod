...
public class BonesandstoneSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:bonesandstone_slab")
	public static final Block block = null;
	public BonesandstoneSlabBlock(BlahmodModElements instance) {
		super(instance, 297);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bonesandstone_slab");
		}
