...
public class EtherealDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_door")
	public static final Block block = null;
	public EtherealDoorBlock(BlahmodModElements instance) {
		super(instance, 544);
	}
