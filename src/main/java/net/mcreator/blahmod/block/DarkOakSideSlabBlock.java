...
public class DarkOakSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dark_oak_side_slab")
	public static final Block block = null;
	public DarkOakSideSlabBlock(BlahmodModElements instance) {
		super(instance, 760);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 6f).setLightLevel(s -> 0).notSolid().harvestTool(ToolType.AXE)
					.setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("dark_oak_side_slab");
		}
