...
public class EtherealFenceBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:ethereal_fence")
	public static final Block block = null;
	public EtherealFenceBlock(BlahmodModElements instance) {
		super(instance, 1880);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("ethereal_fence");
		}
