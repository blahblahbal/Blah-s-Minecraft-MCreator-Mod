...
public class BlackSandstoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:black_sandstone")
	public static final Block block = null;
	public BlackSandstoneBlock(BlahmodModElements instance) {
		super(instance, 125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_sandstone");
		}
