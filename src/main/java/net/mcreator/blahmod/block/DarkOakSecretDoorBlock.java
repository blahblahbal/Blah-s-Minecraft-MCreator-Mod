...
public class DarkOakSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dark_oak_secret_door")
	public static final Block block = null;
	public DarkOakSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 1058);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_secret_door");
		}
