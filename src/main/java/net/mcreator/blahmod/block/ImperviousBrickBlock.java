...
public class ImperviousBrickBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:impervious_brick")
	public static final Block block = null;
	public ImperviousBrickBlock(BlahmodModElements instance) {
		super(instance, 279);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("impervious_brick");
		}
