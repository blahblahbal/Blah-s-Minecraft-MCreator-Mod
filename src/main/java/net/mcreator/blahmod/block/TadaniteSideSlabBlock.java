...
public class TadaniteSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tadanite_side_slab")
	public static final Block block = null;
	public TadaniteSideSlabBlock(BlahmodModElements instance) {
		super(instance, 351);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.STONE).hardnessAndResistance(2f, 6f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("tadanite_side_slab");
		}
