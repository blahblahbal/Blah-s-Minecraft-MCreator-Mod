...
public class CedarWoodBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cedar_wood")
	public static final Block block = null;
	public CedarWoodBlock(BlahmodModElements instance) {
		super(instance, 97);
	}
