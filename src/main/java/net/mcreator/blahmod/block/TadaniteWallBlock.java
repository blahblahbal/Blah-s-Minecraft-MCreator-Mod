...
public class TadaniteWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tadanite_wall")
	public static final Block block = null;
	public TadaniteWallBlock(BlahmodModElements instance) {
		super(instance, 422);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(10f, 250f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("tadanite_wall");
		}
