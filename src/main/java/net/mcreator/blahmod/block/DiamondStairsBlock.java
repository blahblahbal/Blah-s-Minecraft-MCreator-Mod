...
public class DiamondStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:diamond_stairs")
	public static final Block block = null;
	public DiamondStairsBlock(BlahmodModElements instance) {
		super(instance, 524);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("diamond_stairs");
		}
