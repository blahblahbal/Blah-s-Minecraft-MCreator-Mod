...
public class PolishedLightlyCharredScoriaSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_lightly_charred_scoria_slab")
	public static final Block block = null;
	public PolishedLightlyCharredScoriaSlabBlock(BlahmodModElements instance) {
		super(instance, 486);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_lightly_charred_scoria_slab");
		}
