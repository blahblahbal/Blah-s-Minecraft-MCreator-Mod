...
public class FrostWoodPlanksBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_wood_planks")
	public static final Block block = null;
	public FrostWoodPlanksBlock(BlahmodModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frost_wood_planks");
		}
