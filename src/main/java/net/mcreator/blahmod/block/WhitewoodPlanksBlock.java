...
public class WhitewoodPlanksBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:whitewood_planks")
	public static final Block block = null;
	public WhitewoodPlanksBlock(BlahmodModElements instance) {
		super(instance, 1295);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whitewood_planks");
		}
