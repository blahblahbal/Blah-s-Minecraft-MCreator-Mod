...
public class StrippedTropicsLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:stripped_tropics_log")
	public static final Block block = null;
	public StrippedTropicsLogBlock(BlahmodModElements instance) {
		super(instance, 430);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_tropics_log");
		}
