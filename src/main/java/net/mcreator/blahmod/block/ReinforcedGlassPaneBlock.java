...
public class ReinforcedGlassPaneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:reinforced_glass_pane")
	public static final Block block = null;
	public ReinforcedGlassPaneBlock(BlahmodModElements instance) {
		super(instance, 415);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GLASS).hardnessAndResistance(0.3f, 1000f).setLightLevel(s -> 0)
