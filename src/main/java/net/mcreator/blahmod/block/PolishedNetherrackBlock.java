...
public class PolishedNetherrackBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_netherrack")
	public static final Block block = null;
	public PolishedNetherrackBlock(BlahmodModElements instance) {
		super(instance, 121);
	}
