...
public class DarkMatterSmallBushBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dark_matter_small_bush")
	public static final Block block = null;
	public DarkMatterSmallBushBlock(BlahmodModElements instance) {
		super(instance, 441);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dark_matter_small_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:dark_matter_small_bush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("dark_matter_small_bush");
		}
