...
public class FrostWoodFenceGateBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_wood_fence_gate")
	public static final Block block = null;
	public FrostWoodFenceGateBlock(BlahmodModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("frost_wood_fence_gate");
		}
