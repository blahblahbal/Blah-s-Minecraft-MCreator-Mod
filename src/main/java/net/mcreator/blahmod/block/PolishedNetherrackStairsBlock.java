...
public class PolishedNetherrackStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_netherrack_stairs")
	public static final Block block = null;
	public PolishedNetherrackStairsBlock(BlahmodModElements instance) {
		super(instance, 504);
	}
