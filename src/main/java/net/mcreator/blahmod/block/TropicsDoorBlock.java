...
public class TropicsDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_door")
	public static final Block block = null;
	public TropicsDoorBlock(BlahmodModElements instance) {
		super(instance, 217);
	}
