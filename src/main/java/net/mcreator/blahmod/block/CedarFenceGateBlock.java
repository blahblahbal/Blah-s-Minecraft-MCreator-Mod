...
public class CedarFenceGateBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cedar_fence_gate")
	public static final Block block = null;
	public CedarFenceGateBlock(BlahmodModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("cedar_fence_gate");
		}
