...
public class NetherIceBrickWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:nether_ice_brick_wall")
	public static final Block block = null;
	public NetherIceBrickWallBlock(BlahmodModElements instance) {
		super(instance, 427);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(10f, 100f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("nether_ice_brick_wall");
		}
