...
public class SapphireWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sapphire_wall")
	public static final Block block = null;
	public SapphireWallBlock(BlahmodModElements instance) {
		super(instance, 434);
	}
