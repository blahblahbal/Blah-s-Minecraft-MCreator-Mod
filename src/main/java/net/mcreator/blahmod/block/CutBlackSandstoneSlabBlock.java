...
public class CutBlackSandstoneSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cut_black_sandstone_slab")
	public static final Block block = null;
	public CutBlackSandstoneSlabBlock(BlahmodModElements instance) {
		super(instance, 298);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cut_black_sandstone_slab");
		}
