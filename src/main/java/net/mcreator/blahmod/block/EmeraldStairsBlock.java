...
public class EmeraldStairsBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:emerald_stairs")
	public static final Block block = null;
	public EmeraldStairsBlock(BlahmodModElements instance) {
		super(instance, 523);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("emerald_stairs");
		}
