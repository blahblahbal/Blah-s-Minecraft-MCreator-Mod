...
public class CloudStoneSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cloud_stone_secret_door")
	public static final Block block = null;
	public CloudStoneSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 385);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cloud_stone_secret_door");
		}
