...
public class PolishedIgneousRockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_igneous_rock")
	public static final Block block = null;
	public PolishedIgneousRockBlock(BlahmodModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_igneous_rock");
		}
