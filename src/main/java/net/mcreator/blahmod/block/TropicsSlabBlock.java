...
public class TropicsSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_slab")
	public static final Block block = null;
	public TropicsSlabBlock(BlahmodModElements instance) {
		super(instance, 85);
	}
