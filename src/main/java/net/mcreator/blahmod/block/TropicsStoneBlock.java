...
public class TropicsStoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_stone")
	public static final Block block = null;
	public TropicsStoneBlock(BlahmodModElements instance) {
		super(instance, 122);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TropicsCobblestoneBlock.block, (int) (1)));
		}
	}
}
