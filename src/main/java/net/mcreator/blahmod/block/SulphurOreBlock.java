...
public class SulphurOreBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sulphur_ore")
	public static final Block block = null;
	public SulphurOreBlock(BlahmodModElements instance) {
		super(instance, 149);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.NETHERRACK).hardnessAndResistance(1.25f, 10f).setLightLevel(s -> 0)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("blahmod:sulphur_ore_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 5)).range(95)
					.square().func_242731_b(6);
			event.getRegistry().register(feature.setRegistryName("sulphur_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:sulphur_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
