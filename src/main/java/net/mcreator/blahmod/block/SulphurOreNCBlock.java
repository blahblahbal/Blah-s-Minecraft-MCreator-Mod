...
public class SulphurOreNCBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sulphur_ore_nc")
	public static final Block block = null;
	public SulphurOreNCBlock(BlahmodModElements instance) {
		super(instance, 158);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sulphur_ore_nc");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("blahmod:sulphur_ore_nc_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("sulphur_ore_nc"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("blahmod:sulphur_ore_nc"), configuredFeature);
		}
	}
	@SubscribeEvent
