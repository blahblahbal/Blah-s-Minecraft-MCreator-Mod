...
import net.mcreator.blahmod.procedures.PrefabSaplingRClickedProcedure;
...
public class PrefabSaplingBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:prefab_sapling")
	public static final Block block = null;
	public PrefabSaplingBlock(BlahmodModElements instance) {
		super(instance, 205);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("prefab_sapling");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				PrefabSaplingRClickedProcedure.executeProcedure($_dependencies);
			}
