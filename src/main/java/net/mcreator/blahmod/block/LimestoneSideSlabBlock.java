...
public class LimestoneSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:limestone_side_slab")
	public static final Block block = null;
	public LimestoneSideSlabBlock(BlahmodModElements instance) {
		super(instance, 348);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2f, 6f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("limestone_side_slab");
		}
