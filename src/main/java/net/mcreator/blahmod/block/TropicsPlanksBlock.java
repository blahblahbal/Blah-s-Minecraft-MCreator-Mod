...
public class TropicsPlanksBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_planks")
	public static final Block block = null;
	public TropicsPlanksBlock(BlahmodModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tropics_planks");
		}
