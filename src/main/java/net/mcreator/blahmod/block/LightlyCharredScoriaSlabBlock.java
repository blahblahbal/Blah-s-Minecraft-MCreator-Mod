...
public class LightlyCharredScoriaSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lightly_charred_scoria_slab")
	public static final Block block = null;
	public LightlyCharredScoriaSlabBlock(BlahmodModElements instance) {
		super(instance, 482);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("lightly_charred_scoria_slab");
		}
