...
public class GemBiomeStoneBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:gem_biome_stone")
	public static final Block block = null;
	public GemBiomeStoneBlock(BlahmodModElements instance) {
		super(instance, 438);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5f, 3f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("gem_biome_stone");
		}
