...
public class ZirconWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:zircon_wall")
	public static final Block block = null;
	public ZirconWallBlock(BlahmodModElements instance) {
		super(instance, 436);
	}
