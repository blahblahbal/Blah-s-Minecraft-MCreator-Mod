...
public class PolishedSaltrockBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_saltrock")
	public static final Block block = null;
	public PolishedSaltrockBlock(BlahmodModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_saltrock");
		}
