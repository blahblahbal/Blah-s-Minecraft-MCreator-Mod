...
public class AmethystGemLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:amethyst_gem_log")
	public static final Block block = null;
	public AmethystGemLogBlock(BlahmodModElements instance) {
		super(instance, 451);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("amethyst_gem_log");
		}
