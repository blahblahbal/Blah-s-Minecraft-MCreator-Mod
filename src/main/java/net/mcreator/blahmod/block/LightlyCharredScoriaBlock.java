...
public class LightlyCharredScoriaBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lightly_charred_scoria")
	public static final Block block = null;
	public LightlyCharredScoriaBlock(BlahmodModElements instance) {
		super(instance, 480);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightly_charred_scoria");
		}
