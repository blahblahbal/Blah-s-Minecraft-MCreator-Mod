...
public class FrostWoodFenceBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_wood_fence")
	public static final Block block = null;
	public FrostWoodFenceBlock(BlahmodModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("frost_wood_fence");
		}
