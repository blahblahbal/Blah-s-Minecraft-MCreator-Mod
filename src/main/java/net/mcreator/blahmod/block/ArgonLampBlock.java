...
public class ArgonLampBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:argon_lamp")
	public static final Block block = null;
	public ArgonLampBlock(BlahmodModElements instance) {
		super(instance, 516);
	}
