...
public class DreadLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:dread_log")
	public static final Block block = null;
	public DreadLogBlock(BlahmodModElements instance) {
		super(instance, 54);
	}
