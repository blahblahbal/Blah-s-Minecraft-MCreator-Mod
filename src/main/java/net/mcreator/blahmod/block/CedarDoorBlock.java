...
public class CedarDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cedar_door")
	public static final Block block = null;
	public CedarDoorBlock(BlahmodModElements instance) {
		super(instance, 171);
	}
