...
public class SaltrockTileBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:saltrock_tile")
	public static final Block block = null;
	public SaltrockTileBlock(BlahmodModElements instance) {
		super(instance, 113);
	}
