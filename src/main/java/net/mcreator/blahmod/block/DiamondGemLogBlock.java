...
public class DiamondGemLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:diamond_gem_log")
	public static final Block block = null;
	public DiamondGemLogBlock(BlahmodModElements instance) {
		super(instance, 449);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("diamond_gem_log");
		}
