...
public class PolishedCharredScoriaBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_charred_scoria")
	public static final Block block = null;
	public PolishedCharredScoriaBlock(BlahmodModElements instance) {
		super(instance, 476);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_charred_scoria");
		}
