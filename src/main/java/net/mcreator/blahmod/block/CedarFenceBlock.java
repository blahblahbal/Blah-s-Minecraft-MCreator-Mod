...
public class CedarFenceBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:cedar_fence")
	public static final Block block = null;
	public CedarFenceBlock(BlahmodModElements instance) {
		super(instance, 103);
	}
