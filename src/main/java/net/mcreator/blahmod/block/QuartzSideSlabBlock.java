...
public class QuartzSideSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:quartz_side_slab")
	public static final Block block = null;
	public QuartzSideSlabBlock(BlahmodModElements instance) {
		super(instance, 774);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("quartz_side_slab");
		}
