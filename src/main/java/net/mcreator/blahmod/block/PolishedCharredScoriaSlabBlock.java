...
public class PolishedCharredScoriaSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_charred_scoria_slab")
	public static final Block block = null;
	public PolishedCharredScoriaSlabBlock(BlahmodModElements instance) {
		super(instance, 478);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_charred_scoria_slab");
		}
