...
public class PolishedScoriaWallBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_scoria_wall")
	public static final Block block = null;
	public PolishedScoriaWallBlock(BlahmodModElements instance) {
		super(instance, 471);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_scoria_wall");
		}
