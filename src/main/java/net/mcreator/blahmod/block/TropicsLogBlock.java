...
public class TropicsLogBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_log")
	public static final Block block = null;
	public TropicsLogBlock(BlahmodModElements instance) {
		super(instance, 81);
	}
