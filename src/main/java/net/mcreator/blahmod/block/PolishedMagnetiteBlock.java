...
public class PolishedMagnetiteBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:polished_magnetite")
	public static final Block block = null;
	public PolishedMagnetiteBlock(BlahmodModElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_magnetite");
		}
