...
public class TropicsWoodBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tropics_wood")
	public static final Block block = null;
	public TropicsWoodBlock(BlahmodModElements instance) {
		super(instance, 80);
	}
