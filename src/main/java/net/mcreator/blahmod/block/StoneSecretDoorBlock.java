...
public class StoneSecretDoorBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:stone_secret_door")
	public static final Block block = null;
	public StoneSecretDoorBlock(BlahmodModElements instance) {
		super(instance, 1001);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_secret_door");
		}
