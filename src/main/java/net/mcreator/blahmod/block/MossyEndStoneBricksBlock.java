...
public class MossyEndStoneBricksBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:mossy_end_stone_bricks")
	public static final Block block = null;
	public MossyEndStoneBricksBlock(BlahmodModElements instance) {
		super(instance, 292);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_end_stone_bricks");
		}
