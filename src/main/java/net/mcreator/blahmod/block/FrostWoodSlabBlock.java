...
public class FrostWoodSlabBlock extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frost_wood_slab")
	public static final Block block = null;
	public FrostWoodSlabBlock(BlahmodModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("frost_wood_slab");
		}
