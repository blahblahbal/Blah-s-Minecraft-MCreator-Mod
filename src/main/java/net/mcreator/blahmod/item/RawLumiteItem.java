...
public class RawLumiteItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:raw_lumite")
	public static final Item block = null;
	public RawLumiteItem(BlahmodModElements instance) {
		super(instance, 1880);
	}
