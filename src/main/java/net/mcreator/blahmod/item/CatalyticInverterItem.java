...
public class CatalyticInverterItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:catalytic_inverter")
	public static final Item block = null;
	public CatalyticInverterItem(BlahmodModElements instance) {
		super(instance, 84);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("catalytic_inverter");
		}
