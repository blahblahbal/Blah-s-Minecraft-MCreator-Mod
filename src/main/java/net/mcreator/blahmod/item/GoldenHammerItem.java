...
public class GoldenHammerItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:golden_hammer")
	public static final Item block = null;
	public GoldenHammerItem(BlahmodModElements instance) {
		super(instance, 50);
	}
