...
public class SapphireScytheItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sapphire_scythe")
	public static final Item block = null;
	public SapphireScytheItem(BlahmodModElements instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("sapphire_scythe"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab).maxDamage(1203));
		}
