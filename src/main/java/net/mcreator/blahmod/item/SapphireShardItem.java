...
public class SapphireShardItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sapphire_shard")
	public static final Item block = null;
	public SapphireShardItem(BlahmodModElements instance) {
		super(instance, 79);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sapphire_shard");
		}
