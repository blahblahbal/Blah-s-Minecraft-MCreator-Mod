...
public class ObsidianConstructItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:obsidian_construct")
	public static final Item block = null;
	public ObsidianConstructItem(BlahmodModElements instance) {
		super(instance, 81);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("obsidian_construct");
		}
