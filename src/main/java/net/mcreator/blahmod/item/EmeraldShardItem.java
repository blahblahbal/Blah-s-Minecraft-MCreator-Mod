...
public class EmeraldShardItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:emerald_shard")
	public static final Item block = null;
	public EmeraldShardItem(BlahmodModElements instance) {
		super(instance, 77);
	}
