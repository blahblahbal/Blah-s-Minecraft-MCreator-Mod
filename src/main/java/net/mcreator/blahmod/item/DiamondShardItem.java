...
public class DiamondShardItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:diamond_shard")
	public static final Item block = null;
	public DiamondShardItem(BlahmodModElements instance) {
		super(instance, 78);
	}
