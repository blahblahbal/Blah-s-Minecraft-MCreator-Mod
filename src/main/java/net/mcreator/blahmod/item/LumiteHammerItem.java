...
public class LumiteHammerItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lumite_hammer")
	public static final Item block = null;
	public LumiteHammerItem(BlahmodModElements instance) {
		super(instance, 31);
	}
