...
public class WoodScytheItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:wood_scythe")
	public static final Item block = null;
	public WoodScytheItem(BlahmodModElements instance) {
		super(instance, 41);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("wood_scythe"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab).maxDamage(59));
		}
