...
public class GoldScytheItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:gold_scythe")
	public static final Item block = null;
	public GoldScytheItem(BlahmodModElements instance) {
		super(instance, 44);
	}
