...
public class DiamondScytheItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:diamond_scythe")
	public static final Item block = null;
	public DiamondScytheItem(BlahmodModElements instance) {
		super(instance, 45);
	}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab).maxDamage(1561));
		}
