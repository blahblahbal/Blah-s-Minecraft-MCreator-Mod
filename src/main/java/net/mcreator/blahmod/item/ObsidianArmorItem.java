...
import net.mcreator.blahmod.procedures.ObsArmorProcedure;
...
public class ObsidianArmorItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:obsidian_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("blahmod:obsidian_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("blahmod:obsidian_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("blahmod:obsidian_armor_boots")
	public static final Item boots = null;
	public ObsidianArmorItem(BlahmodModElements instance) {
		super(instance, 8);
	}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab)) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "blahmod:textures/models/armor/obsidian__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
				...
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab)) {
					...
					public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
						...
						double z = entity.getPosZ();
						{
							...
							ObsArmorProcedure.executeProcedure($_dependencies);
						}
					}
