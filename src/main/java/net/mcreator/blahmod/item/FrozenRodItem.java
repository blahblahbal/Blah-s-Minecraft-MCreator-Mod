...
public class FrozenRodItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:frozen_rod")
	public static final Item block = null;
	public FrozenRodItem(BlahmodModElements instance) {
		super(instance, 86);
	}
