...
public class NetheriteScytheItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:netherite_scythe")
	public static final Item block = null;
	public NetheriteScytheItem(BlahmodModElements instance) {
		super(instance, 46);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("netherite_scythe"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab).maxDamage(2031).isImmuneToFire());
		}
