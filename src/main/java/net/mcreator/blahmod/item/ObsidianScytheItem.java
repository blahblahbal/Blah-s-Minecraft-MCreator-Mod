...
public class ObsidianScytheItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:obsidian_scythe")
	public static final Item block = null;
	public ObsidianScytheItem(BlahmodModElements instance) {
		super(instance, 6);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("obsidian_scythe"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab).maxDamage(50).isImmuneToFire());
		}
