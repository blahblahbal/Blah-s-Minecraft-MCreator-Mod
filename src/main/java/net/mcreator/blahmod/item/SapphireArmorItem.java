...
public class SapphireArmorItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:sapphire_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("blahmod:sapphire_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("blahmod:sapphire_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("blahmod:sapphire_armor_boots")
	public static final Item boots = null;
	public SapphireArmorItem(BlahmodModElements instance) {
		super(instance, 16);
	}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab)) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "blahmod:textures/models/armor/sapphire__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
