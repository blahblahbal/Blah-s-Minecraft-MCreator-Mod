...
public class TadaniteIngotItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:tadanite_diamond")
	public static final Item block = null;
	public TadaniteIngotItem(BlahmodModElements instance) {
		super(instance, 62);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tadanite_diamond");
		}
