...
public class ObsidianIngotItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:obsidian_ingot")
	public static final Item block = null;
	public ObsidianIngotItem(BlahmodModElements instance) {
		super(instance, 60);
	}
