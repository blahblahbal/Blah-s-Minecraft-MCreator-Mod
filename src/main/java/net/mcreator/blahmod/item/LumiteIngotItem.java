...
public class LumiteIngotItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lumite_ingot")
	public static final Item block = null;
	public LumiteIngotItem(BlahmodModElements instance) {
		super(instance, 63);
	}
