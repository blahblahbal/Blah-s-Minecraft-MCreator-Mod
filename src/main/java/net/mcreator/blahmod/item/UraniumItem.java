...
public class UraniumItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:uranium_helmet")
	public static final Item helmet = null;
	@ObjectHolder("blahmod:uranium_chestplate")
	public static final Item body = null;
	@ObjectHolder("blahmod:uranium_leggings")
	public static final Item legs = null;
	@ObjectHolder("blahmod:uranium_boots")
	public static final Item boots = null;
	public UraniumItem(BlahmodModElements instance) {
		super(instance, 35);
	}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab)) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "blahmod:textures/models/armor/uranium__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
				}.setRegistryName("uranium_helmet"));
		elements.items
				...
				}.setRegistryName("uranium_chestplate"));
		elements.items
				...
				}.setRegistryName("uranium_leggings"));
		elements.items
