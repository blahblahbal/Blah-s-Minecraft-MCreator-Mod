...
public class LumiteSwordItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lumite_sword")
	public static final Item block = null;
	public LumiteSwordItem(BlahmodModElements instance) {
		super(instance, 26);
	}
