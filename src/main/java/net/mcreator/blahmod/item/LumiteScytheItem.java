...
public class LumiteScytheItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:lumite_scythe")
	public static final Item block = null;
	public LumiteScytheItem(BlahmodModElements instance) {
		super(instance, 30);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("lumite_scythe"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CreativeTabBlahItemsItemGroup.tab).maxDamage(4500).isImmuneToFire());
		}
