...
public class CitrineShardItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:citrine_shard")
	public static final Item block = null;
	public CitrineShardItem(BlahmodModElements instance) {
		super(instance, 75);
	}
