...
public class TopazShardItem extends BlahmodModElements.ModElement {
	@ObjectHolder("blahmod:topaz_shard")
	public static final Item block = null;
	public TopazShardItem(BlahmodModElements instance) {
		super(instance, 76);
	}
